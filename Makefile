...
#    Updated: 2024/02/11 19:24:09 by sprodatu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PUSHSWAP_SRCS = append_node.c find_smallest_node.c find_last.c finish_rotation.c \
    ...
    rev_rotate.c set_cur_pos.c set_price.c set_target_node.c stack_init.c \
    stack_length.c syntax_error.c ft_memcpy.c sorted_stack.c ft_swap.c syntax_error.c \
    handle_five.c sa.c find_highest_node.c find_target_node.c push_swap.c handle_five.c\
